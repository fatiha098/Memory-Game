...
const boardGameGenerator = (cardValues, size = 4) => {
  ...
  for (let i = 0; i < size * size; i++) {
    content_game.innerHTML += `
    <div class="tile">
        <img src="${cardValues[i].image}" class="back"/>
        <img src="images/cookie.png" class="front"/>
    </div>
  `;
  }
}
...
// playBtn.addEventListener("click", function(){
//   const start = new Audio('audio/start.mpeg');
//   sound_start.play();
//   window.open("beginner.html",target="_self");
// })
